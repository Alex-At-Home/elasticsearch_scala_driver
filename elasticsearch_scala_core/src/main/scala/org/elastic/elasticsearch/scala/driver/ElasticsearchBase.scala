...
object ElasticsearchBase {
  ...
  /** The exception type generated by REST errors
    ...
    */
  case class EsServerException(code: Int, message: String, body: Option[String]) extends Exception(message)

  /** The exception generated by bad inputs
    *
    * @param message A message summarizing the error (may be empty if no summary can be inferred)
    */
  case class EsRequestException(message: String) extends Exception(message)
