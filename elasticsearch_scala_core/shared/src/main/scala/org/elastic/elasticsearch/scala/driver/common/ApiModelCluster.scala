...
import org.elastic.rest.scala.driver.RestResources.{RestNoDataSendable, RestWritable, _}
...
trait ApiModelCluster {
  ...
  /** The cluster health API allows to get a very simple status on the health of the cluster.
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-health.html Docs]]
    */
  ...
  /** The cluster state API allows to get a comprehensive state information of the whole cluster
    ...
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-state.html Docs]]
    */
  ...
  /** The Cluster Stats API allows to retrieve statistics from a cluster wide perspective.
    ...
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-stats.html Docs]]
    */
  ...
  /** The pending cluster tasks API returns a list of any cluster-level changes (e.g. create index, update mapping,
    ...
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-pending.html Docs]]
    */
  ...
  /** The cluster nodes stats API allows to retrieve one or more (or all) of the cluster nodes statistics.
    ...
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-nodes-stats.html Docs]]
    */
  ...
  /** The cluster nodes info API allows to retrieve one or more (or all) of the cluster nodes information.
    * All info, all nodes
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cluster-nodes-info.html Docs]]
    */
  case class `/_nodes`()
    extends `tree:/_nodes`
      with RestReadable[StandardParams]
  ...
  /** The task management API allows to retrieve information about the tasks currently executing on one or
    * more nodes in the cluster.
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/tasks.html Docs]]
    */
  case class `/_tasks`()
    extends `tree:/_tasks`
      with RestReadable[TaskInfoParams]
      with RestResource

  /** The task management API allows to retrieve information about the tasks currently executing on one or
    * more nodes in the cluster.
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/tasks.html Docs]]
    * @param taskId The id of the task about which to get information
    */
  case class `/_tasks/$taskId`(taskId: String)
    extends `tree:/_tasks/$taskId`
      with RestReadable[TaskInfoParams]
      with RestResource

  /** If a long-running task supports cancellation, it can be cancelled by this resource
    * [[https://www.elastic.co/guide/en/elasticsearch/reference/current/tasks.html Docs]]
    */
  case class `/_tasks/_cancel`()
    extends RestNoDataSendable[TaskCancelParams]
      with RestResource
  ...
  /** If a long-running task supports cancellation, it can be cancelled by this resource
    ...
    * @param taskId The id of the task about which to get information
    */
  case class `/_tasks/$taskId/_cancel`(taskId: String)
